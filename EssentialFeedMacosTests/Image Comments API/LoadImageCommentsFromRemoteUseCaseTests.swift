...
class LoadImageCommentsFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_load_deliversErrorOnNon2xxHTTPResponse() {
        ...
        [199,150,300,400,500].enumerated().forEach {
            index, value in
    ...
    private func expect(_ sut: RemoteImageCommentsLoader, toCompleteWithResult expectedResult: RemoteImageCommentsLoader.Result, when action: () -> (), file: StaticString = #filePath, line: UInt = #line) {
